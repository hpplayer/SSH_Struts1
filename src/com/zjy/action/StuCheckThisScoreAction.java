...
public class StuCheckThisScoreAction extends Action{
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		List<StudentScore> stulist= service.getCurrentScoreByStudentId(st.getId());
		
		// 该语句用来获取会话中所绑定的分页编号
		request.setAttribute("stulist", stulist);
		// 该语句用来获取跳转名page所对应的跳转路径
		return mapping.findForward("thisScore");
	}
}
